export const createIntro = () => {
    ...
    introParagraph2.innerHTML = "Dazu werden zwei Verfahren eingesetzt, die in der wissenschaftlichen Praxis häufig zur Findung von Themen innerhalb von Korpora verwendet werden. Zum einen wird eine Wortfeldanalyse angestellt, bei der verschiedene Wortfelder vordefiniert und die Skripte auf das Auftreten dieser Begriffe untersucht werden. Zum anderen wird auf Basis der Skripte ein topic modeling-Verfahren durchgeführt. Dieser Algorithmus bestimmt auf Basis des gemeinsamen Auftretens verschiedener Begriffe Themenfelder, die im Anschluss interpretiert werden können. Detailliertere Informationen zu beiden Verfahren sind im Abschnitt Methodik zu finden."
